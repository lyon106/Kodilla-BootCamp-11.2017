...
2.5 **Star with filling, appearing after hovering**  
...
3.1 **How does PSD cutting process looks like?**  
...
3.3 **Cutting commercial project**  
...
4.3 **Creating website based on RWD**  
...
4.4 **Upgrade existing site's code to RWD standards**  
...
8.4 **Beginning, another first steps**  
...
8.5 **Type of data and variables**  
...
9.7 **Rock–paper–scissors - designing and coding first application**  
...
9.8 **Another simple landing-page**  
Practice: **Creating website (PSD to HTML) with RWD standards and Sass**  

### Module 10  
##### jQuery  

10.1 **DOM manipulating**  
...
11.1 **Popular paradigms of programming**  
...
11.3 **Introduction to class concept**  
Theory: *Class as blue-print, object as creation based on class*  

11.4 **OOP in practice - implementation concepts in code**  
...
12.2 **AJAX - Asynchronous Javascript And XML**  
...
12.3 **Distinction between synchronous and asynchronous in JavaScript**  
...
12.4 **Description of XMLHttpRequest**  
...
12.6 **API - Application Programming Interface**  
...
12.7 **Kanban App - extended version**  
...
12.8 **PSD to HTML - extended landing page**  
...
13.2 **NodeJS instalation**  
Theory: *LTS as long term support version*  

13.3 **NodeJS indtroduction**  
...
13.4 **Module design pattern - introduction**  
...
13.9 **Creating page to upload files or images**  
...
14.1 **A brief history of web development as a purpose to create frameworks**  
